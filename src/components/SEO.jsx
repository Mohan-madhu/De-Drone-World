...
const routeMeta = {
  ...
  '/about': ['About De Drone World | DGCA Drone Academy Coimbatore', 'Meet De Drone World, an aviation-led drone ecosystem company with DGCA training, UAV operations, manufacturing support, and institutional partnerships in Coimbatore.', 'about De Drone World, DGCA drone academy Coimbatore, UAV company Tamil Nadu, drone training team'],
