...
const programs = [
  ...
  },
  {
    ...
    menuTitle: 'RPC Upgradation',
    eyebrow: 'DGCA Authorised',
    tagline: 'Upgrade Your Drone Operating Class',
    duration: '3 Days Intensive',
    certification: 'DGCA Certified',
    overview:
      'A compact bridge program for certified pilots who want to upgrade their operating capability with guided theory refreshers, simulator practice, and live flight assessment.',
    image: '/assets/training_hero.png',
    ...baseSections,
    timeline: ['Day 1: Rules Refresher & Platform Conversion', 'Day 2: Simulator and Emergency Handling', 'Day 3: Live Flight Assessment'],
  },
];
